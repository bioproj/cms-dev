...
//    public final static String DEFAULT_ARTICLE_PREVIEW_TEMPLATE = "DEFAULT_ARTICLE_PREVIEW_TEMPLATE";
    ...
    public final static String DEFAULT_LITERATURE_CATEGORY_TEMPLATE = "DEFAULT_LITERATURE_CATEGORY_TEMPLATE";
    ...
    public final static String DEFAULT_CATEGORY_DOC_TEMPLATE = "DEFAULT_CATEGORY_DOC_TEMPLATE";
    ...
    public final static String GOODS_DATA = "@Goods";//文章的Components标识
    ...
    public final static String CATEGORY_GOODS_DATA= "@CategoryGoods";//文章的Components标识
